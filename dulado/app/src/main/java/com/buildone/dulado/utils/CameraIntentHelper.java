...
public class CameraIntentHelper {
    private static final String DATE_CAMERA_INTENT_STARTED_STATE = "dateCameraIntentStarted";
    private static final String CAMERA_PIC_URI_STATE = "CAMERA_PIC_URI_STATE";
    private static final String PHOTO_URI_STATE = "PHOTO_URI_STATE";
    private static final String ROTATE_X_DEGREES_STATE = "ROTATE_X_DEGREES_STATE";
    ...
    private CompositeDisposable subscritpions;

    private final static int CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE = 100;

    private CameraIntentHelperCallback mCameraIntentHelperCallback;
    ...
    public void destroy(){
        subscritpions.clear();
        mCameraIntentHelperCallback = null;
    }
}