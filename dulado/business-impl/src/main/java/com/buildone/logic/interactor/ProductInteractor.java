...
public class ProductInteractor implements IProductInteractor {
    ...
    public Observable<ArrayList<SearchObject>> getProducts() {
        ...
        objects.add(new SearchObject(1, "República dos Ladrões", "https://instagram.fsod2-1.fna.fbcdn.net/t51.2885-15/s750x750/sh0.08/e35/18512654_1347226421997221_5058279750112378880_n.jpg", new SellerObject(1,"https://s-media-cache-ak0.pinimg.com/avatars/timsinri_1328981577_280.jpg"), 12.00f, "#nerd #livro"));
        objects.add(new SearchObject(1, "Porta treco", "http://www.artesanatoereciclagem.com.br/wp-content/uploads/2017/05/DIY-Ideias-de-artesanato-com-potes-de-vidro-004.jpg", new SellerObject(1,"https://s-media-cache-ak0.pinimg.com/avatars/timsinri_1328981577_280.jpg"), 0.25f, "#nerd #livro"));
        objects.add(new SearchObject(1, "Corujinha", "https://s-media-cache-ak0.pinimg.com/736x/77/2d/c7/772dc7f9e0e31529723acad12a0b45fe.jpg", new SellerObject(1,"https://s-media-cache-ak0.pinimg.com/avatars/timsinri_1328981577_280.jpg"), 0.25f, "#nerd #livro"));
        objects.add(new SearchObject(1, "Porta Flores", "http://3.bp.blogspot.com/-MIF5WJT7GWU/TbxzqJl-_eI/AAAAAAAAAew/ytLuLQSyA-Y/s1600/30042011263.jpg", new SellerObject(1,"https://s-media-cache-ak0.pinimg.com/avatars/timsinri_1328981577_280.jpg"), 0.25f, "#nerd #livro"));
        objects.add(new SearchObject(1, "Bracelete", "https://img.elo7.com.br/product/zoom/F0855B/mix-de-pulseiras-cham-luu-luxo-colar-masculino.jpg", new SellerObject(1,"https://s-media-cache-ak0.pinimg.com/avatars/timsinri_1328981577_280.jpg"), 0.25f, "#nerd #livro"));
        objects.add(new SearchObject(1, "Porta alfinete", "https://s-media-cache-ak0.pinimg.com/originals/d3/c4/0b/d3c40bf7c14400c51ef02f02e7c49b93.jpg", new SellerObject(1,"https://s-media-cache-ak0.pinimg.com/avatars/timsinri_1328981577_280.jpg"), 0.25f, "#nerd #livro"));
        objects.add(new SearchObject(1, "Coxinha 100un", "https://www.rs21.com.br/wp-content/uploads/2013/01/coxinha.jpg", new SellerObject(1,"https://s-media-cache-ak0.pinimg.com/avatars/timsinri_1328981577_280.jpg"), 0.25f, "#nerd #livro"));
